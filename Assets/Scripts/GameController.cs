...
public class GameController : MonoBehaviour {
	...
	IEnumerator SpawnWaves ()
	{
		...
		while (true) {
			...
			Vector2 spawnPosition3 = new Vector2 (spawnCoordinates.x, Random.Range (-spawnCoordinates.y, spawnCoordinates.y));
			...
			yield return new WaitForSeconds (spawnWaitTime);
			Instantiate (ChasingSpirit, spawnPosition3, Quaternion.identity);
			yield return new WaitForSeconds (spawnWaitTime);
		}
	}
}
